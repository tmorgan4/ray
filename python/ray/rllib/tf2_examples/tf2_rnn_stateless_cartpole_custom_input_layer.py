...
from custom_input_layer import CustomMultiInputLayer
...
if __name__ == "__main__":
    ...
    ### uncomment one of these models, "SequenceMaskRNNmodel" is only model that works properly
    ...
    tune.run(
        ...
        config={
            ...
            "model": {
                "custom_model": "MaskingLayerRNNmodel" if use_masking_layer_model is True else default_model,
